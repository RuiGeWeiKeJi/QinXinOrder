...
namespace Utility
{
    public  class MoneyToRMB
    {
        ...
        protected static bool IsPositveDecimal(string str)
        {
        ...
        /// 需要转换的整数数字字符串
        /// 转换成中文大写后的字符串 
        protected static string ConvertData(string str)
        {
            string tmpstr = "";
            string rstr = "";
        ...
        /// 需要转换的小数部分数字字符串 
        /// 转换成中文大写后的字符串 
        protected static string ConvertXiaoShu(string str)
        {
            int strlen = str.Length;
            string rstr;
            if (strlen == 1)
        ...
        /// 转换的字符串（四位以内） 
        /// 
        protected static string ConvertDigit(string str)
        {
            int strlen = str.Length;
            string rstr = "";
            switch (strlen)
        ...
        /// 转换四位数字 
        /// 
        protected static string Convert4Digit(string str)
        {
        ...
        /// 转换三位数字 
        /// 
        protected static string Convert3Digit(string str)
        {
            string str1 = str.Substring(0, 1);
            string str2 = str.Substring(1, 1);
            string str3 = str.Substring(2, 1);
        ...
        /// 转换二位数字 
        /// 
        protected static string Convert2Digit(string str)
        {
            string str1 = str.Substring(0, 1);
            string str2 = str.Substring(1, 1);
            string rstring = "";
